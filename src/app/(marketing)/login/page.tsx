    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-ivory px-6 pt-20">
      <div className="bg-white p-10 rounded-3xl shadow-xl w-full max-w-md border border-brand-rose/10">
        ...
        <Button 
          ...
          disabled={isLoading}
          className="w-full h-14 bg-brand-dark text-white rounded-xl font-bold text-lg hover:bg-brand-dark/90 transition-all flex items-center justify-center gap-3"
        >
          {isLoading ? (
