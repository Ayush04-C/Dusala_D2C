      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-heading font-bold text-brand-dark mb-6">
            Meet Your Mentor: <br />
            <span className="text-brand-rose">Sugandha Kedia</span>
          </h2>
          ...
          <div className="space-y-6 text-brand-dark">
            <p className="leading-relaxed">
              With over 15 years of experience in the D2C space, Sugandha has navigated the complexities of the Indian market, from supply chain logistics to digital marketing.
            </p>
            <p className="leading-relaxed">
              SK Business Academy is the culmination of her mission to provide every Indian woman with the tools, community, and confidence to become a leader.
            </p>
          </div>
        </motion.div>
      </div>
